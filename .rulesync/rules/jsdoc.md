...
3. **Only the non-obvious tags** — Skip `@param`/`@returns` whose type and name already say everything. Use `@throws` and side-effect notes for what the signature can't express.
